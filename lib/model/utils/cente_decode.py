...
def multi_pose_decode(
    ...
    kps[..., ::2] = xs.view(batch, K, 1).expand(batch, K, num_joints) + kps[...,
                                                                        ::2]  # *  wh[:,:,0].view(batch, K, 1).expand(batch, K, num_joints)
    kps[..., 1::2] = ys.view(batch, K, 1).expand(batch, K, num_joints) + kps[...,
                                                                         1::2]  # *  wh[:,:,1].view(batch, K, 1).expand(batch, K, num_joints)
